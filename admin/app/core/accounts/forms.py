...
class SignIn(UserCacheMixin, Form):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if settings.USE_REMEMBER_ME:
            self.fields["remember_me"] = BooleanField(label=_("Remember me"), required=False)
...
class EmailOrUsernameForm(UserCacheMixin, Form):
    ...
    def clean_email_or_username(self) -> str:
...
class SignUpForm(UserCreationForm):
    ...
    email = EmailField(label=_("Email"), help_text=_("Required. Enter an existing email address."))
