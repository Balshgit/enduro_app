...
def send_mail(to: str, template: str, context: dict[str, Any]) -> None:
...
def send_activation_email(request: HttpRequest, email: str, code: str) -> None:
    context = {
...
def send_activation_change_email(request: HttpRequest, email: str, code: str) -> None:
    context = {
...
def send_reset_password_email(request: HttpRequest, email: str, token: str, uid: str) -> None:
    context = {
...
def send_forgotten_username_email(email: str, username: str) -> None:
    context = {
